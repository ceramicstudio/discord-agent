...
export const generateMemeAction: Action = {
    ...
    handler: async (
        ...
        // Decide randomly or based on the message if a meme should be created
        const shouldMakeMeme = Math.random() < 0.4 || /meme|funny|hilarious|lol|lmao|🤣|😂/i.test(message.content.text);
